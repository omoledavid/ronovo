...
if (isset($_POST['initial_range']) && isset($_POST['final_range']) && ($_POST['final_range'] < $_POST['initial_range'])) {
    $errors['greater'] = $lang['validate_field_ajax8'];
} else if (
    isset($_POST['country_origin'])
    && isset($_POST['country_destiny'])
    && isset($_POST['initial_range'])
    && isset($_POST['final_range'])
) {
    if (cdp_verifyRangeTariffsExist($_POST['country_origin'], $_POST['country_destiny'], $_POST['initial_range'], $_POST['final_range']))
        $errors['valid_range'] = $lang['validate_field_ajax9'];
}
