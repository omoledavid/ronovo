				...
				<?php } else { ?>
					...
					?>
						<tr class="card-hovera">
							...
							<?php } ?>
							<td><b><a href="consolidate_package_view.php?id=<?php echo $row->consolidate_id; ?>"><?php echo $row->c_prefix . $row->c_no; ?></a></b></td>
							...
							<td align='center'>
								<div class="btn-group">
									<button class="btn btn-info btn-sm dropdown-toggle" type="button" data-toggle="dropdown" data-flip="false">
										...
										<?php if ($userData->userlevel != 1) { ?>
											...
											<?php if ($userData->userlevel == 9) { ?>
												<?php if ($row->status_courier != 8) { ?>
													...
													<a class="dropdown-item" href="consolidate_package_edit.php?id=<?php echo $row->consolidate_id; ?>" title="<?php echo $lang['tooledit'] ?>">
