...
function cdp_cal_final_total() {
  ...
  var order_tax_custom_tariffis_value = $(
    "#order_tax_custom_tariffis_value"
  ).val();
...
$("#add_address_recipients_from_modal_shipments").on(
  "submit",
  function (event) {
    ...
    $.ajax({
      type: "POST",
      url:
        "ajax/courier/add_address_recipients_ajax.php?recipient=" +
        recipient_id,
      data: parametros,
      success: function (datos) {
