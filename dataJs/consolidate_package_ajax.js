...
$(".sl-all").on("click", function () {
  $(".custom-table-checkbox input:checkbox")
    .not(this)
  ...
  var $checkboxes = $(".custom-table-checkbox")
    .find("tr > td:first-child")
    .find("input[type=checkbox]");
...
$("#send_checkbox_status").on("submit", function (event) {
  ...
  $.ajax({
    type: "GET",
    url:
      "./ajax/consolidate_packages/consolidate_update_multiple_ajax.php?status=" +
      status,
...
$("#driver_update_multiple").on("submit", function (event) {
  ...
  $.ajax({
    type: "GET",
    url:
      "./ajax/consolidate_packages/consolidate_update_driver_multiple_ajax.php?driver=" +
      driver,
