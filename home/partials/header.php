...
<head>
    ...
    <title><?= $domain ?></title>
    <link rel=icon href="home/assets/img/favicon.png" sizes="20x20" type="image/png">
    ...
    <header class="navbar-area">
        ...
        <nav class="navbar navbar-area-1 navbar-area navbar-expand-lg">
            <div class="container nav-container">
                ...
                <div class="logo">
                    <a href="index.php"><img src="home/assets/img/logo-2.png" alt="img"></a>
                </div>
                ...
                <div class="nav-right-part nav-right-part-mobile">
                    ...
                    <a class="btn btn-base rounded" href="track.php"><span>
                        </span> Track Parcel
                    </a>
                </div>
