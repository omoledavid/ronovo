; (function ($) {
    ...
    $(document).ready(function () {
        ...
        /* -----------------------------------------------------
            Variables
        ----------------------------------------------------- */
        var leftArrow = '<img src="home/assets/img/icon/left-arrow.png">';
        var rightArrow = '<img src="home/assets/img/icon/right-arrow.png">';
        ...
        $('.banner-slider').owlCarousel({
            ...
            items: 1,
            smartSpeed: 1800,
            navText: ['<img src="home/assets/img/icon/left-arrow.png"/>','<img src="home/assets/img/icon/right-arrow.png"/>'],           
        });
