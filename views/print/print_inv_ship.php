...
<body>
    ...
    <table id="items">
        ...
        $sumador_total =   (float)$row->value_weight;
        ...
        <tr class="">
            ...
            <td colspan="3" class="text-right"><b><?php echo $lang['leftorder21'] ?> <?php echo $row->tax_discount; ?> <?php echo $lang['leftorder222221'] ?> </b></td>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td colspan="3" class="text-right"><b><?php echo $lang['leftorder24'] ?> <?php echo $row->tax_insurance_value; ?> <?php echo $lang['leftorder222221'] ?> </b></td>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td colspan="3" class="text-right"> <b><?php echo $lang['leftorder25'] ?> <?php echo $row->tax_custom_tariffis_value; ?> <?php echo $lang['leftorder222221'] ?></b></td>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td colspan="3" class="text-right"><b><?php echo $lang['leftorder67'] ?> <?php echo $row->tax_value; ?> <?php echo $lang['leftorder222221'] ?> </b></td>
            <td class="text-center" id="impuesto"><?php echo $total_impuesto; ?></td>
        </tr>


        <tr>
            <td colspan="2"><b><?php echo $lang['leftorder23'] ?>:</b> <span id="total_peso"><?php echo $sumador_valor_declarado; ?></span></td>
            <td></td>
            <td></td>
            <td></td>
            <td colspan="3" class="text-right"><b><?php echo $lang['leftorder19'] ?> <?php echo $row->declared_value; ?> <?php echo $lang['leftorder222221'] ?> </b></td>
