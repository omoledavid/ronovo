                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
                                    <header>
                                        <span> <?php echo $lang['leftorder325']; ?></span>
                                    </header>
                                    <section>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row->name; ?>" type="text" class="form-control" name="state_name" id="state_name" placeholder="<?php echo $lang['leftorder323']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row->iso; ?>" type="text" class="form-control" name="iso" id="iso" placeholder="<?php echo $lang['leftorder304']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
