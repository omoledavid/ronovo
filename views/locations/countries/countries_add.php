                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
                                    <header class="mb-4">
                                        <span><?php echo $lang['leftorder311'] ?></span>
                                    </header>
                                    <section>
                                        <div class="row">
                                            <div class="col-md-6 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="country_name" id="country_name" placeholder="<?php echo $lang['leftorder303'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="currency" id="currency" placeholder="<?php echo $lang['leftorder306'] ?>">
                                                </div>
                                            </div>
