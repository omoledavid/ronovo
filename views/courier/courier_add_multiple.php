                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr class="card-hover">
                                                        <td class="text-right" colspan="4">
                                                            <b> <?php echo $lang['leftorder19'] ?> <?php echo $lang['leftorder222221'] ?> </b>
                                                        </td>
                                                        <td colspan="1">
                                                    ...
                                                    <tr class="card-hover">
                                                        <td class="text-right" colspan="4">
                                                            <b> <?php echo $lang['leftorder1878'] ?> </b>
                                                        </td>
                                                        <td class="text-right" colspan="2">
                                                            <?php
                                                            if ($core->for_symbol !== null) {
                                                    ...
                                                    <tr class="card-hover">
                                                        <td colspan="2"></td>
                                                        <td colspan="2" class="text-right">
                                                            <b> <?php echo $lang['leftorder2020'] ?> </b>
                                                        </td>
                                                        <td></td>
                                                        <td class="text-right">
                                                            <?php
