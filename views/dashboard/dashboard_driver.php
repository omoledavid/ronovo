                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-lg-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span> <?php echo $lang['dash-general-1222'] ?></span>
                                                <h4 class="font-medium m-b-0">
                                                    <?php
                            ...
                            <div class="card-body">
                                ...
                                <div class="row m-t-30 m-b-20">
                                    ...
                                    <div class="col-sm-12 col-md-12 m-b-10">
                                        <span><?php echo $lang['dash-general-10'] ?></span>
                                        <h4 class="m-b-0">
                                    ...
                                    <!-- col -->
                                    <div class="col-sm-12 col-md-12 m-b-10">
                                        <span><?php echo $lang['dash-general-11'] ?></span>
                                        <h4 class="m-b-0">
                                            <?php echo $core->currency; ?>
                                            <?php
                                    ...
                                    <!-- col -->
                                    <div class="col-sm-12 col-md-12 m-b-10">
                                        <span><?php echo $lang['dash-general-12'] ?></span>
                                        <h4 class="m-b-0">
