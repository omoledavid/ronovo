                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span><?php echo $lang['dash-general-3'] ?></span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->cdp_query("SELECT COUNT(*) as total FROM cdb_consolidate_packages WHERE month(c_date)='$month' AND year(c_date)='$year'");
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span><?php echo $lang['dash-general-3310'] ?></span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->cdp_query("SELECT COUNT(*) as total FROM cdb_consolidate_packages WHERE month(c_date)='$month' AND year(c_date)='$year' and  status_courier=8");
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span><?php echo $lang['dash-general-27'] ?></span>
                                                <h4 class="font-medium m-b-0">
                                                    ...
                                                    $db->cdp_query("SELECT IFNULL(SUM(total_order), 0) as total FROM cdb_consolidate_packages WHERE month(c_date)='$month' AND year(c_date)='$year'");
