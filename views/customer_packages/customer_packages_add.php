                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="tracking_purchase" id="tracking_purchase" placeholder="<?php echo $lang['left63'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive " id="table-totals">
                                            <table id="insvoice-item-table" class="table">
                                                <tfoot>
                                                    ...
                                                    <tr class="card-hover">
                                                        <td colspan="1"><b><?php echo $lang['left905'] ?> &nbsp; <?php echo $core->weight_p; ?>:</b></td>
                                                        <td colspan="1">
                                                        ...
                                                        <td colspan="2" class="text-right"> <b><?php echo $lang['leftorder21'] ?> <?php echo $lang['leftorder222221'] ?></b></td>
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="4" class="text-right"> <b><?php echo $lang['leftorder24'] ?> <?php echo $lang['leftorder222221'] ?></b></td>
                                                        <td colspan="1" class="text-right">
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="4" class="text-right"><b><?php echo $lang['leftorder25'] ?> <?php echo $lang['leftorder222221'] ?></b></td>
                                                        <td colspan="1" class="text-right">
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td colspan="4" class="text-right"><b> <?php echo $lang['leftorder67'] ?> <?php echo $lang['leftorder222221'] ?></b></td>
                                                        <td colspan="1">
                                                    ...
                                                    <tr class="card-hover">
                                                        ...
                                                        <td class="text-right" colspan="4"><b><?php echo $lang['leftorder19'] ?> <?php echo $lang['leftorder222221'] ?></b></td>
                                                        <td colspan="1">
