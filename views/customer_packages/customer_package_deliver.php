...
if (isset($_POST['person_receives'])) {
    ...
    if (isset($_POST['sig-dataUrl'])) {
        ...
        $img = str_replace(' ', '+', $img);
        file_put_contents('doc_signs/customer_packages/' . $id . '.png', base64_decode($img));
    }
    ...
    if (empty($errors)) {
        ...
        // Input string
        $subjectVal_sender = cdp_getsmsTemplates(9);
                                        ...
                                        ?>
                                            <div class="col-sm-12 col-md-5 offset-1 mt-4">
                                                <label class="custom-control custom-checkbox" style="font-size: 18px; padding-left: 0px">
                                                    ...
                                                    <b><?php echo $lang['leftorder144430'] ?> &nbsp; <i class="fa fas-whatsapp" style="font-size: 22px; color:#07bc4c;"></i></b>
