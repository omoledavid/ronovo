            ...
            <div class="container-fluid">
                ...
                ?>
                    <div class="row">
                        <div class="col-lg-12 col-xl-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><i class="fa fa-paperclip"></i> <?php echo $lang['leftorder56'] ?></h5>
                                    <hr>
                ...
                ?>
                    <div class="row">
                        <div class="col-lg-12 col-xl-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><i class="fa fa-paperclip"></i> <?php echo $lang['leftorder59'] ?></h5>
                ...
                ?>
                        <div class="row">
                            <div class="col-lg-12 col-xl-12 col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo $lang['left533020001'] ?></h5>
                                        <hr>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $lang['left533020009'] ?></h5>
                                <hr>
                                    ...
                                    <table class="table table-hover" id="tabla">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="card-hover">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="2" class="text-right"><b><?php echo $lang['leftorder21'] ?> <?php echo $row_order->tax_discount; ?> <?php echo $lang['leftorder222221'] ?> </b></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="3" class="text-right"><b><?php echo $lang['leftorder22'] ?></b></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="3" class="text-right"><b><?php echo $lang['leftorder24'] ?> <?php echo $row_order->tax_insurance_value; ?> <?php echo $lang['leftorder222221'] ?></b></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="3" class="text-right"> <b><?php echo $lang['leftorder25'] ?> <?php echo $row_order->tax_custom_tariffis_value; ?> <?php echo $lang['leftorder222221'] ?></b></td>
                                            ...
                                            <tr>
                                                <td colspan="3"><b><?php echo $lang['leftorder23'] ?></b> <span>: <?php echo $sumador_valor_declarado; ?></span></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td colspan="2" class="text-right"><b><?php echo $lang['leftorder67'] ?> <?php echo $row_order->tax_value; ?> <?php echo $lang['leftorder222221'] ?> </b></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="2" class="text-right"><b><?php echo $lang['leftorder19'] ?> <?php echo $row_order->declared_value; ?> <?php echo $lang['leftorder222221'] ?> </b></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="2" class="text-right"><b><?php echo $lang['leftorder1878'] ?> </b></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="2" class="text-right"><b><?php echo $lang['langs_048'] ?> </b></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="3" class="text-right"><b><?php echo $lang['leftorder2020'] ?> &nbsp; <?php echo $core->currency; ?></b></td>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $lang['left533020010'] ?></h5>
                                <hr>
