                                ...
                                <div class="card-body">
                                    ...
                                    <table class="tablesaw table-hover table no-border">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="title"><a class="link" href="report_consolidate_packages_general_list.php"><i class="ti ti-arrow-right" style="color:#00D900"></i> <?php echo $lang['report-general024'] ?></a></td>
                                            </tr>

                                            <?php if ($user->userlevel == 9 || $user->userlevel == 2) { ?>

                                                <tr>
                                                    <td class="title"><a class="link" href="report_consolidate_packages_customers_list.php"><i class="ti ti-arrow-right" style="color:#00D900"></i> <?php echo $lang['report-general025'] ?></a></td>
                                                </tr>

                                                <tr>
                                                    <td class="title"><a class="link" href="report_consolidate_packages_employees_list.php"><i class="ti ti-arrow-right" style="color:#00D900"></i> <?php echo $lang['report-general026'] ?></a></td>
                                                </tr>

                                                <tr>
                                                    <td class="title"><a class="link" href="report_consolidate_packages_agency_list.php"><i class="ti ti-arrow-right" style="color:#00D900"></i> <?php echo $lang['report-general027'] ?></a></td>
                                                </tr>

                                                <tr>
                                                    <td class="title"><a class="link" href="report_consolidate_packages_driver_list.php"><i class="ti ti-arrow-right" style="color:#00D900"></i> <?php echo $lang['report-general028'] ?></a></td>
                                                </tr>
