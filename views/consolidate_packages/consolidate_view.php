            ...
            <div class="container-fluid">
                                                ...
                                                <div class="dropdown-menu scrollable-menu">
                                                    ...
                                                    <?php if ($userData->userlevel == 9 || $userData->userlevel == 2) { ?>
                                                        <?php if ($row_order->status_courier != 8) { ?>
                                                            <a class="dropdown-item" href="consolidate_package_edit.php?id=<?php echo $_GET['id']; ?>" title="<?php echo $lang['tooledit'] ?>"><i style="color:#343a40" class="ti-pencil"></i>&nbsp;<?php echo $lang['tooledit'] ?></a>
                                                        <?php } ?>
                                                    <?php } ?>
                                    ...
                                    <table class="table table-hover" id="tabla">
                                        <thead class="bg-inverse text-white">
                                            <tr>
                                                ...
                                                <th colspan="2" class="text-right"><b><?php echo $lang['left215'] ?></b></th>
                                        ...
                                        <tfoot>
                                            <tr class="card-hover">
                                                <td colspan="2"></td>
                                                <td colspan="2"></td>
                                                <td colspan="3" class="text-right"><b><?php echo $lang['leftorder2021'] ?></b></td>
                                            ...
                                            <tr class="card-hover">
                                                <td colspan="2"><b><?php echo $lang['left905'] ?> &nbsp; <?php echo $core->weight_p; ?>:</b> <?php echo $row_order->value_weight; ?></td>
                                                <td colspan="2"></td>
                                            ...
                                            <tr>
                                                <td colspan="2"></td>
                                                <td colspan="2"></td>
                                                <td colspan="3" class="text-right"><b><?php echo $lang['langs_048'] ?> </b></td>
                                                <td class="text-right" id="reexp"><?php echo cdb_money_format($row_order->total_reexp); ?></td>
                                                <td></td>
                                            </tr>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $lang['left533020011'] ?></h5>
                                <hr>
                                <!-- <hr> -->
                                <div class="row">
