...
if (isset($_POST["create_invoice"])) {
    ...
    $db->bind(':comments', $lang['notification_shipment28']);
    ...
    header("location:consolidate_package_view.php?id=$order_id");
?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="invoice-item-table" class="table">
                                            <div align="right">
                                                <button type="button" data-toggle="modal" data-target="#myModalConsolidate" class="btn btn-success mb-2">
