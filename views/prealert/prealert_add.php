                                        ...
                                        <form method="post" accept-charset="utf-8" name="form_prealert" id="form_prealert">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 nondoc">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control add-listing_form" name="tracking_prealert" id="tracking_prealert" placeholder="<?php echo $lang['left63'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div>
                                                        <label class="control-label" id="selectItem"> <?php echo $lang['leftorder01215'] ?></label>
                                                    </div>
                                                    ...
                                                    <button type="button" id="openMultiFile" class="btn btn-default  pull-left "> <i class='fa fa-paperclip' id="openMultiFile" style="font-size:18px; cursor:pointer;"></i> <?php echo $lang['leftorder16'] ?> </button>
