                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="<?php echo $row_data->initial_range; ?>" class="form-control" name="initial_range" id="initial_range" placeholder="<?php echo $lang['leftorder297'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="<?php echo $row_data->final_range; ?>" class="form-control" name="final_range" id="final_range" placeholder="<?php echo $lang['leftorder298'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="<?php echo $row_data->price; ?>" class="form-control" name="tariff_price" id="tariff_price" placeholder="<?php echo $lang['leftorder299'] ?>">
                                                </div>
                                            </div>
                                        </div>
