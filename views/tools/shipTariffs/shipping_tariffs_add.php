                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
                                    <header><span><?php echo $lang['leftorder300'] ?></span></header> <br><br>
                                    <section>
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width: 100% !important;" class="select2 form-control" name="state_destinystates" id="state_destinystates" disabled>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width: 100% !important;" class="select2 form-control" name="city_destinycities" id="city_destinycities" disabled>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="initial_range" id="initial_range" placeholder="<?php echo $lang['leftorder297'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="final_range" id="final_range" placeholder="<?php echo $lang['leftorder298'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="tariff_price" id="tariff_price" placeholder="<?php echo $lang['leftorder299'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
