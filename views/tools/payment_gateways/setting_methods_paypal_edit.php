                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name_pay" value="<?php echo $row_off->name_pay; ?>" placeholder="<?php echo $lang['tools-config117'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="lastName1"><?php echo $lang['tools-config118'] ?></label>
                                                    <input type="text" class="form-control" name="detail_pay" value="<?php echo $row_off->detail_pay; ?>" placeholder="<?php echo $lang['tools-config118'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="paypal_client_id" value="<?php echo $row_off->paypal_client_id; ?>" placeholder="<?php echo $lang['tools-config119'] ?>">
                                                </div>
                                            </div>
                                        </div>
