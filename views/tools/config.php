						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="site_email" id="site_email" title="<?php echo $lang['tools-config6'] ?>" data-toggle="tooltip" value="<?php echo $core->site_email; ?>" placeholder="<?php echo $lang['tools-config5'] ?>">
								</div>
							</div>
						</div>
