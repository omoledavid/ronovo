			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-5 align-self-center">
						<span><?php echo $lang['tools-config61'] ?> | <?php echo $lang['user_manage37'] ?></span>
						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="save_user" name="save_user" method="post">
									<section>
										<header><span><?php echo $lang['user_manage37'] ?></span></header>
										<br>
										<br>
										<div class="row">
											<div class="col-md-4">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select class="custom-select form-control" id="userlevel" name="userlevel">
														<?php echo $user->cdp_getUserLevels(false, $lang); ?>
													</select>
												</div>
											</div>
										</div>
