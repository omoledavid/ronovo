			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-5 align-self-center">
						<span><?php echo $lang['tools-config61'] ?> | <?php echo $lang['tools-statuscourier20']; ?></span>
						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
									<header> <span><?php echo $lang['tools-statuscourier2'] ?> <i class="icon-double-angle-right"></i> <?php echo $row_off->mod_style; ?></span></header> <br><br>
									<section>
										<div class="row">
											<div class="col-md-6">
