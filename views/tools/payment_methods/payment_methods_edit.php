                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
                                    <header><span><?php echo $lang['tools-methodpay2'] ?> <i class="icon-double-angle-right"></i> <?php echo $row_off->label; ?></span></header> <br><br>
                                    <section>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="detail" value="<?php echo $row_off->days; ?>" placeholder="<?php echo $lang['tools-methodpay1123'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
