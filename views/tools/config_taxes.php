										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="min_cost_tax" id="min_cost_tax" value="<?php echo $core->min_cost_tax; ?>" placeholder="<?php echo $lang['tools-config77'] ?>">
												</div>
											</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="min_cost_declared_tax" id="min_cost_declared_tax" value="<?php echo $core->min_cost_declared_tax; ?>" placeholder="<?php echo $lang['tools-config76'] ?>">
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="declared_tax" id="declared_tax" value="<?php echo $core->declared_tax; ?>" placeholder="<?php echo $lang['tools-config78'] ?>">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="meter" id="meter" value="<?php echo $core->meter; ?>" placeholder="<?php echo $lang['tools-config50'] ?> / <?php echo $core->meter; ?>">
												</div>
											</div>
