				...
				<form class="form-horizontal form-material" id="save_config_general" name="save_config_general" method="post">
					...
					<section>
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<select class="custom-select form-control" name="timezone" id="timezone">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="cformat"><?php echo $lang['tools-config91'] ?></label>
							...
							<div class="col-md-3">
								...
								<div class="form-group">
									<label for="dec_point"><?php echo $lang['tools-config92'] ?></label>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label for="thousands_sep"><?php echo $lang['tools-config93'] ?></label>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="currency_decimal_digits"><?php echo $lang['tools-config95'] ?></label>
									<select class="form-control" name="for_currency" id="for_currency" value="<?php echo $core->for_currency; ?>">

										<option value="p" <?php if ($core->for_currency == 'p') echo " selected=\"selected\""; ?>><?php echo $lang['texttttt1'] ?></option>
										<option value="s" <?php if ($core->for_currency == 's') echo " selected=\"selected\""; ?>><?php echo $lang['texttttt2'] ?></option>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="currency_decimal_digits"><?php echo $lang['tools-config96'] ?></label>
