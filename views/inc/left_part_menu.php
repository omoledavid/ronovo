					...
					<ul class="list-group" id="sidebarnav">
						...
						<li class="list-group-item sidebar-item"><a class="list-group-item-action has-arrow waves-effect waves-dark" href="javascript:void(0)"> <i class="mdi mdi-playlist-plus"></i> <?php echo $lang['apis03'] ?></a>
							<ul aria-expanded="false" class="collapse  first-level">
								...
								<li class="list-group-item sidebar-item"><a href="activate_whatsapp.php" class="sidebar-link"><i class="ti ti-check" style="color:#975EF7"></i><span class="menutext"><?php echo $lang['left1110'] ?></span></a></li>


								<li class="list-group-item sidebar-item"><a href="config_twilio.php" class="sidebar-link"><i class="ti ti-check" style="color:#975EF7"></i><span class="menutext"><?php echo $lang['left1112'] ?></span></a></li>
						...
						<li class="list-group-item sidebar-item"><a class="list-group-item-action has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"> <i class="mdi mdi-playlist-plus"></i><?php echo $lang['leftorder255'] ?></a>
							<ul aria-expanded="false" class="collapse  first-level">
								...
								<li class="list-group-item sidebar-item"><a href="activate_sms.php" class="sidebar-link"><i class="ti ti-check" style="color:#975EF7"></i><span class="menutext"><?php echo $lang['left1113'] ?></span></a></li>


								<li class="list-group-item sidebar-item"><a href="config_sms.php" class="sidebar-link"><i class="ti ti-check" style="color:#975EF7"></i><span class="menutext"><?php echo $lang['left1114'] ?></span></a></li>

								<li class="list-group-item sidebar-item"><a href="templates_sms.php" class="sidebar-link"><i class="ti ti-check" style="color:#975EF7"></i><span class="menutext"><?php echo $lang['left1115'] ?></span></a></li>
