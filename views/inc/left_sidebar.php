		...
		<nav class="sidebar-nav">
				...
				<ul id="sidebarnav">
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="drivers_list.php" aria-expanded="false">
									<i class="ti ti-check" style="color:#975EF7"></i>
									<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-32'] ?></span>
								</a>
							</li>
						</ul>
					</li>
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="newsletter.php" aria-expanded="false">
									<i class="ti ti-check" style="color:#975EF7"></i>
									<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-36'] ?></span>
								</a>
							</li>
						</ul>
					</li>
								...
								<ul aria-expanded="false" class="collapse  first-level">
									...
									<li class="sidebar-item">
										<a class="sidebar-link waves-effect waves-dark" href="payment_methods_list.php">
											<i class="fas fa-hand-holding-usd" style="color:#975EF7"></i>
			...
			<?php } else if ($userData->userlevel == 2) { ?>
				...
				<ul id="sidebarnav">
					...
					<li class="nav-small-cap">
						<i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu"><?php echo $lang['left-menu-sidebar-3'] ?></span>
					</li>
			...
			<?php } else if ($userData->userlevel == 1) { ?>
				...
				<ul id="sidebarnav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link waves-effect waves-dark" href="customers_edit.php?user=<?php echo $userData->id; ?>" aria-expanded="false"><i class="mdi mdi-account"></i>
